...
@section('content')
    ...
    <section class="team-container">
        ...
        <div class="row">
            <div class="content-col">
                ...
                <p>Neque porro quisquam <br> est qui dolorem ipsum <br> quia dolor sit amet, <br> consectetur, adipisci
                    velit</p>
    ...
    <section class="join">
        ...
        <a href="{{ url('contact') }}"><button class="btn btn-secondary btn-large">Get Connected</button></a>
    </section>
@endsection
